    ...
    <section id="contact" className="py-20 bg-white border-t">
      <div className="container mx-auto px-4 text-center">
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="max-w-4xl mx-auto mb-10 flex justify-end"
        >
          <div className="bg-gray-50 rounded-2xl px-6 py-5 shadow-md border border-gray-100 text-right inline-flex flex-col items-center gap-4 min-w-[160px]">
            <p className="text-sm font-bold text-gray-600 tracking-wide">تابعونا</p>
            <div className="flex items-center gap-4">
              ...
              <a
                ...
                className="w-11 h-11 flex items-center justify-center rounded-xl bg-gradient-to-br from-purple-500 via-pink-500 to-orange-400 text-white shadow hover:scale-110 hover:shadow-lg transition-all duration-200"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="w-11 h-11 flex items-center justify-center rounded-xl bg-[#1877F2] text-white shadow hover:scale-110 hover:shadow-lg transition-all duration-200"
              >
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="YouTube"
                className="w-11 h-11 flex items-center justify-center rounded-xl bg-[#FF0000] text-white shadow hover:scale-110 hover:shadow-lg transition-all duration-200"
              >
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
